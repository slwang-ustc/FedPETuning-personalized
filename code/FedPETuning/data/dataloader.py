...
class GlueDataLoader(BaseDataLoader):
    ...
    def _reader_examples(
        self, raw_data, partition_data, n_clients,
        ...
        for idx in range(n_clients):
            ...
            # test
            client_test_list = clients_partition_data["test"][idx]
            test_examples_num_dict[idx] = len(client_test_list)
            test_features_dict[idx] = test_fedtures_all[client_test_list]
