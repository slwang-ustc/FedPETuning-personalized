...
class BaseDataLoader(ABC):
    ...
    def _load_federated_data_on_server(self):
        ...
        if os.path.isfile(self.cached_data_file):
            ...
            train_features_dict, valid_features_dict, test_features_dict, valid_fedtures_all, test_fedtures_all, \
            train_examples_num_dict, valid_examples_num_dict, test_examples_num_dict = self._convert_examples_to_features()
    ...
    def _load_federated_data_on_client(self):
        ...
        if self.federated_config.do_mimic:
            ...
            for idx in self.clients_list:
                ...
                test_dataloader_dict[idx] = self.build_dataloader(test_features_dict[idx], "test")
        else:
            # Local data loading
        ...
        self.train_examples_num_dict = train_examples_num_dict
        self.valid_examples_num_dict = valid_examples_num_dict
        self.test_examples_num_dict = test_examples_num_dict
    ...
    def _convert_examples_to_features(self):
        ...
        federated_data = self._reader_examples(
            raw_data=raw_data, partition_data=partition_data, n_clients=n_clients,
            train_examples_num_dict=train_examples_num_dict, valid_examples_num_dict=valid_examples_num_dict, test_examples_num_dict=test_examples_num_dict,
            train_features_dict=train_features_dict, valid_features_dict=valid_features_dict, test_features_dict=test_features_dict,
            valid_fedtures_all=valid_fedtures_all, test_fedtures_all=test_fedtures_all
        )

        self.logger.info("saving processed features ...")
        pickle_write(federated_data, self.cached_data_file)

        # return train_features_dict, valid_features_dict, test_features_dict, valid_fedtures_all, test_fedtures_all, \
        #        train_examples_num_dict, valid_examples_num_dict, test_examples_num_dict
        # TODO hard code check return dict
        return federated_data[0:8]
    ...
    def _load_attributes(self):
        ...
        # self.logger.info(f'attribute: {self.attribute}\n')
