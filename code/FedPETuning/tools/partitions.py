...
def label_skew_process(label_vocab, label_assignment, client_num, alpha,
    ...
    # new
    return partition_result, proportions_client_list


def label_skew_process_fix(
    label_vocab, label_assignment, client_num, data_length, proportions_client_list
):
    """
    params
    -------------------------------------------------------------------
    ...
    for client_id in range(len(partition_result)):
        ...
        # new
        proportions = proportions_client_list[client_id]
        # proportions = np.random.dirichlet(client_dir_dis)
