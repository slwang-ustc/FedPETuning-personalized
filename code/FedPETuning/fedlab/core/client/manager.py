...
class ClientManager(NetworkManager):
    ...
    Args:
        ...
        trainer (BaseClient): Subclass of :class:`BaseClient`. Provides :meth:`local_process` and :attr:`uplink_package`. Define local client trainers procedure.
    """
...
class ActiveClientManager(ClientManager):
    ...
    def main_loop(self):
        """Actions to perform on receiving new message, including local trainers
